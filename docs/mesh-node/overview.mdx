...
│                            liop-node (Rust Core)                            │
├───────────────────────────────┬─────────────────────────────────────────────┤
│         Network Layer         │               Execution Layer               │
│  Tonic gRPC (h2 / QUIC)       │  Wasmtime v29.0 (WASI Preview 1)            │
│  rust-libp2p (Kademlia DHT)   │  Instruction Fuel Metering (`set_fuel`)     │
│  Noise Protocol (Ed25519)     │  Memory Isolation & Linear Memory Trap      │
│  Post-Quantum (ML-KEM-768)    │  ZK-VM Receipt Hooks (HMAC-SHA256)          │
└───────────────────────────────┴─────────────────────────────────────────────┘
```

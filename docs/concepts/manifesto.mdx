...
Review the [Protocol Specification](/concepts/specification), run the [Interactive Playground](http://localhost:16000), or instantiate an enclave node using the TypeScript SDK via `npm install @nekzus/liop`. See the [Getting Started Guide](/getting-started/quickstart).

...
description: "The 6 architectural layers of the Logic-Injection-on-Origin Protocol."
---
...
- Enforces an $\epsilon \ge 1.0$ floor for $n < 10$ and relies exclusively on OS-level CSPRNG (`crypto.randomBytes`), physically neutralizing deterministic state-reconstruction attacks.

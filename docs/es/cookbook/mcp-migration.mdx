...
<Frame caption="Arquitectura Tradicional MCP frente a Arquitectura Puenteada de LIOP">
  <img className="block dark:hidden w-full" src="/images/bridge-flow-light.svg" alt="Arquitectura del Puente LIOP MCP" />
  <img className="hidden dark:block w-full" src="/images/bridge-flow-dark.svg" alt="Arquitectura del Puente LIOP MCP" />
</Frame>

...
```
                   ...
                   ┌─────────────────┼─────────────────┐
                   ▼                 ▼                 ▼
          [Modo Pasarela]     [Modo Híbrido]      [Modo Malla]
          HTTP-MCP Directo    Ruta por Función    gRPC P2P Puro
                   │                 │                 │
                   └────────► ┌──────┴──────┐ ◄────────┘
                      ...
                      ┌──────────────┴──────────────┐
                      ▼                             ▼
               [TokenManager]              [Pool de Piscina]
           OAuth 2.1 Preemptivo       ML-KEM / AST Fuera de Hilo
```
...
- **`getAllToolDefinitions()`**: Retorna la lista de herramientas activas ordenadas alfabéticamente, cumpliendo con la especificación `tools/list` del protocolo MCP.

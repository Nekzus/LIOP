...
*   **Estructura Dinámica de Retorno (Auto-i18n):** No requiere configuración manual. El `LiopServer` inyecta automáticamente directivas *Dynamic Return Structure* en los payloads. Esto obliga a la IA a respetar y devolver las llaves JSON exactamente en el mismo idioma nativo que utilizó el cliente al hacer la solicitud, eliminando la necesidad de librerías de internacionalización (i18n) en tu frontend.

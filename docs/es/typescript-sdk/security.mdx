...
Para protegerse contra ataques de agotamiento de CPU que ejecutan bucles computacionales ocultos, el motor analiza estáticamente el Árbol de Sintaxis Abstracta (AST) de JavaScript mediante `calculateAstInstructionFuel`:

- Analiza la complejidad del AST (profundidad de bucles, factor de ramificación, declaraciones de funciones) antes de la ejecución.
- Inyecta un presupuesto estricto y determinista de combustible en el ejecutor del isolate V8.

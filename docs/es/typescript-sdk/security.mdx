...
El escáner PII intercepta toda la salida del sandbox **antes** de devolver los resultados al llamador. Aplica una combinación de patrones regex y validadores algorítmicos para detectar y bloquear datos sensibles.
...
- **Búsqueda de Claves Prohibidas**: Bloqueo O(1) mediante `Set<string>.has()` para nombres de campo como `ssn`, `email`, `password`, `privateKey`

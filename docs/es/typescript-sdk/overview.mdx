...
- **Seguridad en Profundidad:** Soporte nativo para TLS/mTLS, configuraciones descentralizadas y Rate-Limiting por ventana deslizante anti-DoS.
...
<Frame>
  <img className="block dark:hidden w-full" src="/images/animated-sdk-flow-light.svg" alt="Flujo Arquitectónico del SDK NMP" />
  <img className="hidden dark:block w-full" src="/images/animated-sdk-flow-dark.svg" alt="Flujo Arquitectónico del SDK NMP" />
</Frame>

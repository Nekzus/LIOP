...
# Ejecuta las 11 suites automatizadas (59 pruebas) de Vitest dentro del contenedor audit-runner
pnpm audit:prod:run
```
...
## Batería de Pruebas Automatizadas (Suites 00 a 10)

El arnés ejecuta **11 suites exhaustivas de Vitest** (59 pruebas individuales) en el contenedor `liop-audit-runner`:
...
11. **`plug-and-play`**: Validación "plug-and-play" de extremo a extremo que confirma que el SDK arranca, descubre peers, ejecuta inyecciones lógicas y devuelve resultados criptográficamente atestados sin configuración manual alguna.

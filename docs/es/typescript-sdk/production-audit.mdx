...
* **Escalamiento Bootstrap Monte Carlo**: Cargas sostenidas de inferencia estadística (30 a 40 iteraciones de remuestreo con varianza, covarianza y correlación de Pearson) generan un escalamiento determinista y proporcional del fuel WASI de 300 a 400 hasta 700 a 900 unidades (+75% a +125%), capturado en vivo por el histograma `liop_fuel_consumed_total`.

...
### Estructura Dinámica de Retorno (Localización de Datos en Origen) [PLANIFICADO]
LIOP introduce un patrón arquitectónico donde la traducción y localización de datos ocurre directamente en el momento de la ejecución. Esta funcionalidad está en la hoja de ruta.

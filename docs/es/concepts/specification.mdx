...
- Impone un piso de $\epsilon \ge 1.0$ para $n < 10$ y se apoya exclusivamente en CSPRNG a nivel de SO (`crypto.randomBytes`), neutralizando físicamente los ataques de reconstrucción de estado determinista.

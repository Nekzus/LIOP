...
- **Defensa contra Canal Lateral de Tiempo:** El objeto `Date` se envenena dentro del sandbox para prevenir que la lógica inyectada mida diferencias de tiempo de ejecución, que podrían usarse para inferir el tamaño del dataset o patrones de ejecución internos.
...
- **Defensa contra Contaminación de Prototipos:** Seis prototipos core de JavaScript (`Object`, `Array`, `String`, `Number`, `Boolean`, `Function`) se congelan vía `Object.freeze()` dentro del IIFE del sandbox antes de que el código de usuario se ejecute, previniendo que la lógica inyectada sobreescriba métodos nativos.

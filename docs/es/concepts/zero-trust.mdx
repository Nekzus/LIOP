...
- **Acuerdo de Clave Post-Cuántica (ML-KEM-768)**: LIOP emplea **Kyber768 (ML-KEM-768)** para el intercambio de claves y **AES-256-GCM** para el cifrado del payload, protegiendo contra ataques cuánticos ("Harvest Now, Decrypt Later").

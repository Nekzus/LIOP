...
<Frame caption="Flujo de Enclaves Soberanos y Atestación TEE">
  <img className="block dark:hidden w-full" src="/images/animated-tee-flow-light.svg" alt="Flujo de Enclaves Soberanos y Atestación TEE" />
  <img className="hidden dark:block w-full" src="/images/animated-tee-flow-dark.svg" alt="Flujo de Enclaves Soberanos y Atestación TEE" />
</Frame>

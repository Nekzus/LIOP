...
│                                 LiopServer                                  │
├───────────────────────────────┬─────────────────────────────────────────────┤
│         Ingress Layer         │               Security Shield               │
│  Tonic gRPC H2 / TLS / mTLS   │  Layer 1: Guardian AST (14-import allowlist)│
│  OAuth 2.1 RFC 8707 Validator │  Layer 2: V8 Sandbox (25 poisoned globals)  │
│  ML-KEM-768 Post-Quantum Key  │  Layer 3: Taint Analyzer (IFC)              │
│  Piscina Worker Pool (Crypto) │  Layer 4: Egress PII Shield (Regex/NER)     │
│                               │  Layer 5: Aggregation-First Policy          │
│                               │  Layer 6: ZK-Receipt (HMAC-SHA256 Seal)     │
└───────────────────────────────┴─────────────────────────────────────────────┘
```

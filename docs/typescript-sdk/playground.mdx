...
* **Telemetry** (`TelemetryTab`):
  * **Token Economy vs MCP**: Side-by-side comparison of BPE tokens consumed (`o200k_base`) against the ~16,000 to 48,000 tokens required by traditional MCP context-pulling.

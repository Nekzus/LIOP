...
Because the Server enforces a strict `WASI` sandbox and uses the *Guardian AST* to inspect your `.wasm` payload before execution, your client must be prepared to handle sandbox rejections.

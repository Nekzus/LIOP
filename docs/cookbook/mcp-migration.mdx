...
<Frame caption="Traditional MCP Context Pulling vs. LIOP Bridged Architecture">
  <img className="block dark:hidden w-full" src="/images/bridge-flow-light.svg" alt="LIOP MCP Bridge Architecture" />
  <img className="hidden dark:block w-full" src="/images/bridge-flow-dark.svg" alt="LIOP MCP Bridge Architecture" />
</Frame>

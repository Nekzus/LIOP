...
<Frame caption="Sovereign Enclaves & TEE Attestation Flow">
  <img className="block dark:hidden w-full" src="/images/animated-tee-flow-light.svg" alt="Sovereign Enclaves & TEE Attestation Flow" />
  <img className="hidden dark:block w-full" src="/images/animated-tee-flow-dark.svg" alt="Sovereign Enclaves & TEE Attestation Flow" />
</Frame>

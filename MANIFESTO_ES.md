...
Estos siete principios gobiernan cada decisión arquitectónica del protocolo. No son aspiracionales, sino restricciones obligatorias. Una contribución que viole cualquiera de ellos se rechaza.
...
5. **Resiliencia Cuántica**. Todos los intercambios de claves y sellos de sesión utilizan algoritmos post-cuánticos (ML-KEM-768) desde el primer día. No es un camino de actualización futura, sino un requisito de lanzamiento diseñado contra estrategias de cosecha-ahora-descifra-después.

...
## [2.4.6](https://github.com/Nekzus/LIOP/compare/v2.4.5...v2.4.6) (2026-08-31)


### Bug Fixes

* **security:** upgrade wasmtime and wasmtime-wasi to 48.0.1 in liop-node to resolve 17 Dependabot advisories ([1542843](https://github.com/Nekzus/LIOP/commit/1542843f50f865dfe60df8d6c65d7cedc78acdf4))
...
## [2.4.5](https://github.com/Nekzus/LIOP/compare/v2.4.4...v2.4.5) (2026-08-30)
...
* **router:** Windows Firewall Mitigation with Localhost routing + gRPC Error handling ([78b40c1](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/78b40c15da614a26c0db580b105e68474d82889c))
* **router:** semantic indexing of NmpMeshStatus and linter fixes ([18ab90a](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/18ab90a074b4c4a307efb36d755e414cec38363e))
* **router:** remove remote status tools & add 40 hardening tests ([3611799](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/3611799632d6bb7b4a640d2241724180da37d2bd))
* **sdk:** add missing await in router readResource ([518c715](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/518c71581e30ce5b7eaf62cacca911ca38a03bbc))
* **sdk:** add node: protocol to built-in imports ([4af86a4](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/4af86a4ef22e0700b0f9647f2f305b564a9ab3ee))
* **sdk:** add robust event-based reader fallback in queryManifest ([d830549](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/d8305492e3a7fab1619a997fe8e19fc533cfb76a))
* **sdk:** bundle .proto files for NPM distribution ([e2914d9](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/e2914d9d570c41841c57de02b952aefe03d29b01))
...
* **sdk:** eradicate last client intent mock, fix .gitignore identity rules ([83b62b4](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/83b62b4395e3096a6c42380055d184457749c852))
* **sdk:** move organizeImports to assist section in biome.json ([a7cf460](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/a7cf460cf9530950e540726fa13af22bedd3f553))
...
* **sdk:** update entrypoints to match v1.2 LiopServer API ([8d9b701](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/8d9b701515f545af6103c5058111050e0e4f776f))
...
* **economy:** Token Economy Engine BPE tokenization & OTel metrics ([76ac53d](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/76ac53db2efd62d74aacebfe6b69cec31edd98e5))
* **economy:** Token Economy Engine centralized spec, compact envelope, telemetry ([459914c](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/459914c9a2df274a3785f2e7f6dd34a2c615a4fc))
* **global:** Unificación total de marca LIOP y Paridad de Protocolo v1.0.0-alpha ([00bdc81](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/00bdc813aaa4599afdad60a8af90dca20c4cd593))
...
* Implement initial NMP TypeScript SDK including client, server, mesh networking ([86e2b2f](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/86e2b2f835a89fb006d6338680b97eb4808c6ecd))
* **mesh-node:** align manifest serving with official libp2p standards ([0cafeeb](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/0cafeebafb8691b0c885fdea34ee6a721006eee9))
* **mesh:** validate cross-platform discovery and industrial routing ([96faaf7](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/96faaf7bdc0e9ea8156d96a569c2bac9add618f5))
* Neural Mesh Protocol - Full Industrial LOO Migration & Safety Alignment ([1100dbe](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/1100dbe8a14341c777a2463ecd6d9b99e49d47c5))
* NMP Industrial High-Fidelity - Precision Logic Extraction & Spec Compliance ([6fd2152](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/6fd2152e57e17a408f9bfd14e06459a124a9d661))
* **nmp-alpha:** complete alpha phase with e2e validation ([f2eb84e](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/f2eb84ecdcaf2d31bd7a1ee72d84261c2885092a))
* **nmp-mesh:** Final Alpha Release with Multi-Node Topology ([e265172](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/e265172a8362e5ed61017dbf74a6b5f49c76362b))
* **router:** Zero-Trust topology visibility in MCP tools ([873ca0e](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/873ca0edb4f34b41221afc5aef76e630a5710171))
...
* **sdk:** achieve Tier-0 industrial standards for LIOP protocol ([bebe433](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/bebe433931738fd54dbf3cba3fbf68bb9ba20b09))
* **sdk:** align MCP 2025-11-25, smart warm-up stabilization, adaptive DHT polling ([695fdb7](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/695fdb75cd034d00d1dbe605a9f3c00880294de9))
* **sdk:** eradicate mocks and harden TypeScript ZK parity ([c3f7ff3](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/c3f7ff39b9857527b12d95e96320ba7d6a243f01))
* **sdk:** finalize industrial parity v1.2.0-beta ([73ffd2b](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/73ffd2b9a9ac22b9df6ec3ae42443e1d0aec5ce2))
* **sdk:** fully synchronized discovery fix and updated project bitacora ([ec86481](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/ec86481b42b17d78ab95e450fee45ba57ad82ec))
...
* **sdk:** implement dynamic tool discovery with LAN-DHT ([84787d4](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/84787d4c22312be0ec350743f6ff5601894f539b))
...
* **sdk:** implement Phase 91 Mesh Discovery ([394753d](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/394753d8ed25126903e188988e4e3c89bb1165c4))
* **sdk:** implement Phase 92 Cross-AI Adaptors and Phase 93 PII Shield ([fb7d900](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/fb7d900732b1cedeb25c46b66bd84850db05a6cb))
...
* **sdk:** migrate PQC to FIPS 203 (mlkem), harden gRPC/Piscina ([8c2caa5](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/8c2caa5810b5b55aaf70fc567324021f59f5ba20))
* **sdk:** modernize to McpServer API, silence console ([c600c27](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/c600c27ae2ac330fa10dc2571f99d2bb311b3166))
* **sdk:** phase 94 production hardening (logger, env cfg, mcp types) ([f6477a2](https://github.com/Nekzus/Neural-Mesh-Protocol/commit/f6477a2612d9525571270963288736772de1ac01))
